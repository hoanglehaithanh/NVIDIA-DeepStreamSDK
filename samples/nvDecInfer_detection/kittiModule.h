...
*/
                  *logFile[videoIndex] <<"Frame "<<frameIndex<<"-"<<vSynsets_[bboxs.bbox[i].category]<<"-"<<bboxs.bbox[i].x*nWidth<<" "<<bboxs.bbox[i].y*nHeight<<" "<<(bboxs.bbox[i].x + bboxs.bbox[i].w)*nWidth<<" "<<(bboxs.bbox[i].y + bboxs.bbox[i].h)*nHeight<<"\n";
			}
		}
