...
> THIS IS AN OLD VERSION OF DEEPSTREAM SDK, WHICH USES DIFFERENT ARCHITECTURE FROM LATER VERSIONS. THIS VERSION IS EASILY TO USE BUT ONLY USES TENSORRT 3 AND DOES NOT SUPPORT MANY LASTEST DEEP LEARNING MODELS.
